...
if(isset($_POST['save_multiple_data']))
{
    ...
    // $checkquery="SELECT * from selected_subjectslab where Fid='$FID'";
    //     $res=mysqli_query($conn,$checkquery);
    //     $row = mysqli_fetch_array($res);
        
    //     if ($row){
    //         $delquery="DELETE from selected_subjectslab where Fid='$FID'";
    ...
    foreach($subj as $index => $subject)
    {
        ...
        if (in_array($subject,$sub_array)){
            ...
            try{
            $query = "INSERT INTO laballocation(FacultyID,CourseID,AllocationType,Semester,Program,Year) VALUES ('$FID','$subject','LAB','$subsem','$subprogram',2022)";
