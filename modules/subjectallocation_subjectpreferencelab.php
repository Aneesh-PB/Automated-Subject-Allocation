...
if (isset($_SESSION['user_name'])) {
  ...
  $Fidquery="select FacultyID from login_info where Username='$username'";
  $Fidqueryres=mysqli_query($conn,$Fidquery);
  $Fidcol=mysqli_fetch_array($Fidqueryres);
  $Fid=$Fidcol['FacultyID'];
  $_SESSION['Fid']=$Fid;
    ...
    <div id="wrapper-div">
      ...
      <div id="main-div" class="clearfix">
        ...
        <div>
                        ...
                        <h4 style="text-align:left;">Faculty Name: <?php echo $username; ?></h4>
                        <br>
                    </div>
        

<form action="subjectallocation_subjectpreference_insertlab.php" method="POST">
            ...
            <div class="col-md-4">
                <div class="form-group mb-2">
                 ...
                 <option value="" disabled selected>Select Subject</option>
                    <?php
                    $query="select * from subjects where Type='LAB' and Semester in ('S1','S3','S5','S7','M1','M3')order by Semester,Program";
                    $resu=mysqli_query($conn,$query);
                    
                    while($row=mysqli_fetch_array($resu)){
                    ?>
                    
                    <option value="<?php echo $row['CourseCode'];?>"><?php echo $row['Semester']." - ".$row['Program']." - ".$row['CourseCode']." - ".$row['CourseName'];?></option>
                    <?php
                } 
                ?>
                    </select>
